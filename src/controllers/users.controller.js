...
export const getUsers = async (req, res) => {
  try {
    ...
    return res.status(500).send({ message: "Erro ao buscar os usuários", error: error.message});
  }
...
export const getUserById = async (req, res) => {
  try {
    ...
    return res.status(500).send({ message: "Erro ao buscar o usuário por id", error: error.message});
  }
